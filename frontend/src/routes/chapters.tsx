...
const getSchoolInitials = (chapter: Chapter) => {

  const known = SCHOOL_INITIALS[chapter.university];

  if (known) return known;

  const ignored = new Set(["of", "the", "at", "and"]);

  const generated = chapter.university
  ...
  return generated || chapter.shortName.slice(0, 4).toUpperCase();
